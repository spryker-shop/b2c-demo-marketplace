...
class CombinedMerchantProductOfferStoreDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    ...
    {
        return MerchantProductOfferDataImportConfig::PYZ_IMPORT_TYPE_COMBINED_MERCHANT_PRODUCT_OFFER_STORE;
    }
    ...
    {
        return $this->getFacade()->pyzImportCombinedMerchantProductOfferStoreData($dataImporterConfigurationTransfer);
    }
}
